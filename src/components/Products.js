...
const Products = () => {
  ...
  const isItemInCart = (items, productId) => {
    const product = items.find((item) => productId === item.productId);
  ...
  return (
    <div>
      ...
      <Grid container>
                      ...
                      return (
                        <Grid item md={3} xs={6} key={p._id}>
                          <ProductCard
                            product={p}
                            handleAddToCart={() =>
                              addToCart(token, cart, product, p._id, 1, {
        ...
        {token && (
          <Grid item md={3} xs={12} sx={{ bgcolor: "#E9F5E1" }}>
            <Cart
              products={product}
              items={generateCartItemsFrom(cart, product)}
